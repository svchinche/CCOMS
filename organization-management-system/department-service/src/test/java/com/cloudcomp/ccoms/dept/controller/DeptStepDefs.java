...
public void i_should_get_valid_HTTP_response_code_of_GET_request_with_all_Departments_information_in_UI(Integer int1) {
    // Write code here that turns the phrase above into concrete actions
    throw new cucumber.api.PendingException();
}

@When("I set HTTP GET request RESTful API with URI dept {int}")
public void i_set_HTTP_GET_request_RESTful_API_with_URI_dept(Integer int1) {
    // Write code here that turns the phrase above into concrete actions
    throw new cucumber.api.PendingException();
}
...
public void i_set_HTTP_GET_request_RESTful_API_with_org_with_id_URI(Integer int1) {
    // Write code here that turns the phrase above into concrete actions
    throw new cucumber.api.PendingException();
}
...
@When("I set HTTP GET request RESTful API with org with org {int} withemp URI")
public void i_set_HTTP_GET_request_RESTful_API_with_org_with_org_withemp_URI(Integer int1) {
    // Write code here that turns the phrase above into concrete actions
    throw new cucumber.api.PendingException();
}

@Then("I should get valid HTTP response code {int} of GET request for respective dept")
public void i_should_get_valid_HTTP_response_code_of_GET_request_for_respective_dept(Integer int1) {
    // Write code here that turns the phrase above into concrete actions
    throw new cucumber.api.PendingException();
}
...
@Then("I should get valid HTTP response code {int} of GET request with all Departments information in UI with pretty")
public void i_should_get_valid_HTTP_response_code_of_GET_request_with_all_Departments_information_in_UI_with_pretty(Integer int1) {
    // Write code here that turns the phrase above into concrete actions
    throw new cucumber.api.PendingException();
}
...
public void i_should_get_valid_HTTP_response_code_of_GET_request_with_all_Depts_information_with_emp_and_orgs(Integer int1) {
    // Write code here that turns the phrase above into concrete actions
    throw new cucumber.api.PendingException();
}
...
public void i_set_HTTP_GET_request_without_any_resource_mentioned_in_API() {
    // Write code here that turns the phrase above into concrete actions
    throw new cucumber.api.PendingException();
}

@Then("I should get valid HTTP response code {int} for that request with warning message")
public void i_should_get_valid_HTTP_response_code_for_that_request_with_warning_message(Integer int1) {
    // Write code here that turns the phrase above into concrete actions
    throw new cucumber.api.PendingException();
}
